...
import { createIRMaterial, uploadIRFile } from "../actions";

export default function CreateIRMaterialPage() {
  ...
  const { mutate: createIRMaterialMutation, isPending } = useMutation({
    mutationFn: (data: {
      title: string;
      description: string;
      file_url?: string;
    ...
    }) => createIRMaterial(data),
    onSuccess: () => {
      alert("IR 자료가 성공적으로 생성되었습니다.");
      router.push("/dashboard");
    },
    onError: (error) => {
      console.error("createIRMaterial 에러:", error);
      alert("IR 자료 생성 중 오류가 발생했습니다.");
    },
  });
      ...
      <div className="max-w-4xl mx-auto">
        <div className="bg-white rounded-2xl shadow-xl overflow-hidden">
          <div className="bg-gradient-to-r from-primary-600 to-primary-700 px-8 py-6">
            <h1 className="text-3xl font-bold text-white">IR 자료 생성</h1>
